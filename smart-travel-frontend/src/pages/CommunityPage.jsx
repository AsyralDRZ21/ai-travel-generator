            ...
            return (
              <div key={post._id} className="post-card">
                ...
                {activeReplyPost === post._id && (
                  <div className="post-replies fade-in" style={{ marginTop: '16px', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '16px' }}>
                    {post.replies?.length > 0 ? post.replies.map((reply, i) => (
                      <div key={i} style={{ marginBottom: '12px', background: 'rgba(0,0,0,0.2)', padding: '12px', borderRadius: '8px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '8px', marginTop: '12px' }}>
                      <input type="text" placeholder="Write a reply..." value={replyText} onChange={e => setReplyText(e.target.value)}
                        ...
                        style={{ flex: 1, padding: '10px 16px', borderRadius: '20px', background: 'rgba(255,255,255,0.05)', border: '1px solid var(--glass-border)', color: 'var(--text-primary)', outline: 'none' }}
                      />
